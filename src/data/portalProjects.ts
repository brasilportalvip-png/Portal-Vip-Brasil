...
export const USER_PORTFOLIO_PROJECTS: PortalProject[] = [
  {
    ...
    category: 'Espiritualidade & Devoção',
  ...
  },
  {
    ...
    category: 'Amor & Atração Magnética',
    ...
    color: 'from-rose-600/20 to-purple-900/20'
  },
  {
    id: 'proj_manual_catolico',
    name: 'Manual Católico',
    slug: 'manual-catolico',
    category: 'Tradição Católica & Fé',
    ...
    color: 'from-blue-600/20 to-sky-800/10'
  },
  {
    id: 'proj_frocia2',
    name: 'Froc IA',
    slug: 'froc-ia',
    category: 'Inteligência Artificial & Conteúdo',
  ...
  },
  {
    ...
    category: 'Automação & Redes Sociais',
